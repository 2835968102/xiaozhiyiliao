...
public class EmbeddingTest {
    ...
    public void testEmbeddingModel(){
        ...
        Response<Embedding> embd = embeddingModel.embed("你好");

        System.out.println("向量维度： " + embd.content().vector().length);
        System.out.println("向量输出： " + embd.toString());
